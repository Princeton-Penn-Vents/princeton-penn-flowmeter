...
def make(current_time):
    ...
    breaths = get_breath_starts(current_time=current_time, max_time=sim_time, breathing_rate=breathing_rate)
    ...
    time = np.arange(current_time, current_time + sim_time, 1.0 / sample_rate)
...
def main(timer):
    global last_time
    time_arr, flow_arr, volume_arr, pressure_arr = make(last_time)
